    ...
    "data": {
        ...
        "followup_performance": [ { "attempt": 1, "sent": 50, "opened": 18, "clicked": 5, ... } ]
            ...
            <section id="webhooks-intro" class="mb-16 scroll-mt-24 pt-10 border-t border-navy/10">
                ...
                <p class="text-navy/65 leading-relaxed mb-4 max-w-2xl text-[15px]">
                    Crea y gestiona webhooks desde <a href="{{ route('settings.webhooks.index') }}" class="underline underline-offset-4 decoration-navy/30 hover:decoration-navy">Ajustes → Webhooks</a> o desde los endpoints <code class="font-mono text-xs bg-navy/5 px-1.5 py-0.5 rounded">/webhooks</code> del propio API. El secret de firma se muestra una sola vez al crear el webhook — guárdalo en un vault.
                </p>
                <div class="grid sm:grid-cols-2 gap-4 max-w-2xl">
                    <div class="p-4 rounded-xl bg-sand-light/60 border border-navy/10">
  ...
  return crypto.timingSafeEqual(
    ...
    Buffer.from(parts.v1, 'hex'),
            ...
            <section id="webhooks-retries" class="mb-16 scroll-mt-24">
                ...
                <p class="text-navy/65 leading-relaxed mb-4 max-w-2xl text-[15px]">
                    El webhook lleva un contador de <strong>eventos consecutivos fallidos</strong> (no intentos — eventos). Si llega a 10, Roomie desactiva el webhook automáticamente para dejar de quemar capacidad. Verás <code class="font-mono text-xs bg-navy/5 px-1.5 py-0.5 rounded">active: false</code> y podrás re-activarlo desde <a href="{{ route('settings.webhooks.index') }}" class="underline underline-offset-4 decoration-navy/30 hover:decoration-navy">Ajustes → Webhooks</a> o con <code class="font-mono text-xs bg-navy/5 px-1.5 py-0.5 rounded">PATCH /webhooks/:id</code>. Una respuesta 2xx exitosa resetea el contador.
                </p>
